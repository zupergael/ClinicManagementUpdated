    ...
    protected void handleLogin() {
        ...
        try (java.sql.Connection conn = DBConnection.getConnection()) {
            ...
            if (accountType.equals("Secretary")) {
                sql = "SELECT * FROM user_secretary WHERE username = ? AND password = ? AND account_type = ?";
            } else {
                sql = "SELECT * FROM user WHERE username = ? AND password = ? AND account_type = ?";
            }
            ...
            if (rs.next()) {
                String fxmlFile = switch (accountType) {
                    ...
                    case "Secretary" -> "SecretaryDashboard.fxml";
                    default -> null;
                };
                ...
                if (fxmlFile != null) {
                    ...
                    stage.setTitle("Clinic Management - " + accountType);
                    stage.show();
                } else {
